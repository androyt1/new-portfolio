...
import Computer from "./components/compute_and_laptop";
        ...
        <div className='flex-1    relative flex  '>
            <div className='grid grid-cols-1 md:grid-cols-2   bg-gray-900'>
                <div className='h-[50vh] md:h-full md:12 px-5 lg:pl-36 flex flex-col items-start justify-center '>
                    ...
                    <h1 className='text-4xl md:text-5xl lg:text-6xl font-extrabold drop-shadow-lg mt-4  md:mt-4  font-annabel text-balance text-[#faf9f9]'>
                        Aghoghovwia Andrew
                    </h1>
